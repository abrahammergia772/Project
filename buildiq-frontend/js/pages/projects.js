  ...
  function shell() {
    return `
      <div class="page-header">
        <div><h1>Projects <span class="text-muted" id="projCount" style="font-size:16px;"></span></h1><div class="page-sub">Track progress, risk, and delivery across all sites</div></div>
        <div class="page-header-actions"><button class="btn btn-primary" id="newProjectBtn"><i class="fa-solid fa-plus"></i> New Project</button></div>
      </div>
